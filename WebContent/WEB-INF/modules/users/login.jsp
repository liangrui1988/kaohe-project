...
<head>
<link rel="stylesheet"
	href="<%=basePath%>/resources/css/login_style.css">
...
<body>
	...
	<main>
	<form class="form" action="<%=basePath%>/UserLogin" method="post">
		...
		<div class="form__content">
			...
			<div class="styled-input">
				<img id="jcaptchajpgid" src="jcaptcha.jpg"
					onclick="getJcaptchajpg()" />
			</div>
			<div class="styled-input">
				<input type="text" name="jcaptcha" class="styled-input__input"
					value="" />
				<div class="styled-input__placeholder">
