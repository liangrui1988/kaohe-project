...
<script
	src="<%=basePath%>/resources/js/jquery/jquery.validate/jquery.validate.js"></script>
<script
	src="<%=basePath%>/resources/js/jquery/jquery.validate/jquery.validate.method.js"></script>
		...
		<form id="inputForm" action="" class="form-horizontal" role="form">
			...
			<div class="form-group">
				<label class="col-sm-1 control-label"> <span
					class="help-inline"><font color="red">*</font> </span>登陆名：
				</label>
				<div class="col-sd-1">
					<input class="required input-xlarge" maxlength="20" name="userName"
						id="_userName" type="text" readonly="readonly" />
				</div>
			...
			<div class="form-group">
				...
				<div class="col-sd-1">
					<input maxlength="16" placeholder="不填不修改密码" name="password"
						type="password" id="_password" />
				</div>
			</div>


			<div class="form-group">
				<label class="col-sm-1 control-label">重新输入密码： </label>
				<div class="col-sd-1">
					<input maxlength="16" placeholder="不填不修改密码" name="repeatPassword"
						type="password" id="_repeatPassword" />
				</div>
			</div>
			...
			<div class="form-group">
				<label class="col-sm-1 control-label "> <span
					class="help-inline"><font color="red">*</font>状态：</label>
				<div class="col-sd-1">
					&nbsp; &nbsp;&nbsp;启用 <input type="radio" name="status" value="0"
						checked="checked" /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;禁用<input
